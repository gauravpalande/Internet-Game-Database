...
namespace AmazonProductAdvtApi
{
    ...
    {
        private const string MY_AWS_ACCESS_KEY_ID = "AKIAJA55LRZQZGWIL5ZQ";
        private const string MY_AWS_SECRET_KEY    = "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";
        private const string DESTINATION          = "ecs.amazonaws.com";
        
        private const string NAMESPACE = "http://webservices.amazon.com/AWSECommerceService/2009-03-31";
        private const string ITEM_ID   = "B00008OE6I";
        ...
        public static void Main()
        {
            ...
            r1["AUnicodeString"] = "Hello";
            r1["Latin1Chars"] = "Hello";
